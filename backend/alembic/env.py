...
def _is_async_url(url: str) -> bool:
    """Check if the database URL uses an async driver."""
...
def run_migrations_online_sync() -> None:
    ...
    Used when the database URL does not use an async driver (e.g. SQLite).
    """
    url = config.get_main_option("sqlalchemy.url")
...
def run_migrations_online() -> None:
    ...
    Delegates to async or sync runner depending on the database URL.
    """
    url = config.get_main_option("sqlalchemy.url")
